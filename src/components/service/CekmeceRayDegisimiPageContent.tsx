...
import {
  ...
  SERVICE_REPLACE_VS_ADJUST,
  SERVICE_REPLACE_VS_ADJUST_SECTION,
  ...
  type ServiceReplaceVsAdjustIcon,
...
export function CekmeceRayDegisimiPageContent() {
  return (
    <>
      <ServiceHeroSection />
      <WorkStagesSection />
...
function HeroShowcase({
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[10px] font-bold text-cream-50 sm:text-xs">Hızlı Değişim</p>
      </m.div>
    </m.div>
  );
}
...
function ReplaceVsAdjustSection() {
  return (
    <section
      id="degisim-mi-ayar-mi"
      className="section-padding scroll-mt-14 bg-white sm:scroll-mt-20"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow={SERVICE_REPLACE_VS_ADJUST_SECTION.eyebrow}
          title={SERVICE_REPLACE_VS_ADJUST_SECTION.title}
          description={SERVICE_REPLACE_VS_ADJUST_SECTION.description}
        />
        ...
        <m.div
          ...
          variants={staggerContainer}
        >
          {SERVICE_REPLACE_VS_ADJUST.map((option) => (
            <m.article
              key={option.id}
              variants={fadeInUp}
            ...
            >
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-wood-100 to-wood-200 text-wood-700 transition-colors duration-300 group-hover:from-wood-800 group-hover:to-wood-900 group-hover:text-cream-50 sm:h-11 sm:w-11 sm:rounded-2xl">
                <ReplaceVsAdjustIcon name={option.icon} className="h-5 w-5" />
              </div>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="max-w-xl text-sm leading-relaxed text-wood-700 sm:text-base">
            Siz de çekmece ve ray fotoğrafınızı gönderin, yapılabilecek işlemler hakkında ön bilgi alın.
          </p>
          <m.a
            href={whatsappHref}
            target="_blank"
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Çekmece Ray Değişimi Hakkında Merak Edilenler"
          description="Mersin'de yerinde çekmece ray değişimi hizmetiyle ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Çekmece ray değişimi iletişim">
  ...
  const icons: Record<ServiceWorkStageIcon, ReactNode> = {
    ...
    drawer: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M4 10h16M4 16h16M10 10v6M14 10v6" strokeLinecap="round" />
      </svg>
    ),
    tv: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
  ...
  const icons: Record<ServiceProblemIcon, ReactNode> = {
    stuck: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M5 10h10M15 10v6" strokeLinecap="round" />
      </svg>
    ),
    broken: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M4 8h7l2 4 2-4h5M4 16h16" strokeLinecap="round" strokeLinejoin="round" />
    ...
    softclose: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M4 8h12a4 4 0 0 1 0 8H4" strokeLinecap="round" />
    ...
    sag: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M7 18h10M12 15v3" strokeLinecap="round" />
      </svg>
    ),
    tv: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
    ...
    drawer: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <rect x="4" y="4" width="16" height="16" rx="1" />
        <path d="M4 10h16M4 16h16" strokeLinecap="round" />
      </svg>
    ),
    photo: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
...
function ReplaceVsAdjustIcon({
  name,
  className = "h-5 w-5",
}: {
  name: ServiceReplaceVsAdjustIcon;
  className?: string;
}) {
  const icons: Record<ServiceReplaceVsAdjustIcon, ReactNode> = {
    replace: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M4 8h16M4 16h16" strokeLinecap="round" />
        <rect x="6" y="10" width="12" height="4" rx="0.5" />
        <path d="M16 4l2 2-2 2M8 20l-2-2 2-2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    adjust: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
    ...
    both: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M16 15l2 2 3-4" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  };
