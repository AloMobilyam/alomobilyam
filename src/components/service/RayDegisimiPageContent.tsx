...
import {
  ...
  type ServiceRailTypeIcon,
  type ServiceWorkStageIcon,
} from "@/lib/services/ray-degisimi";
...
export function RayDegisimiPageContent() {
  return (
    <>
      <ServiceHeroSection />
      <WorkStagesSection />
...
function RailTypesSection() {
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow={SERVICE_RAIL_TYPES_SECTION.eyebrow}
          title={SERVICE_RAIL_TYPES_SECTION.title}
          description={SERVICE_RAIL_TYPES_SECTION.description}
        />
        ...
        <m.div
          ...
          variants={staggerContainer}
        >
          {SERVICE_RAIL_TYPES.map((railType) => (
            <m.article
              key={railType.id}
              variants={fadeInUp}
            ...
            >
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-wood-100 to-wood-200 text-wood-700 transition-colors duration-300 group-hover:from-wood-800 group-hover:to-wood-900 group-hover:text-cream-50 sm:h-11 sm:w-11 sm:rounded-2xl">
                <RailTypeIcon name={railType.icon} className="h-5 w-5" />
              </div>
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Ray Değişimi Hakkında Merak Edilenler"
          description="Mersin'de yerinde ray değişimi hizmetiyle ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Ray değişimi iletişim">
...
function RailTypeIcon({
  name,
  className = "h-5 w-5",
}: {
  name: ServiceRailTypeIcon;
  className?: string;
}) {
  const icons: Record<ServiceRailTypeIcon, ReactNode> = {
    telescopic: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M3 12h6M9 12h6M15 12h6" strokeLinecap="round" />
        <path d="M6 9v6M12 8v8M18 9v6" strokeLinecap="round" />
      </svg>
    ),
    roller: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
    ...
    full: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M13 12h8M18 9l3 3-3 3" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    under: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
