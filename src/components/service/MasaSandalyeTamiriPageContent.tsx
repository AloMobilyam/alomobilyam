...
export function MasaSandalyeTamiriPageContent() {
  return (
    <>
      <ServiceHeroSection />
...
function HeroShowcase({
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[10px] font-bold text-cream-50 sm:text-xs">Masa Sandalye</p>
      </m.div>
    </m.div>
  );
}
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="max-w-xl text-sm leading-relaxed text-wood-700 sm:text-base">
            Siz de masa veya sandalyenizin fotoğrafını gönderin, yapılabilecek onarım işlemleri hakkında ön bilgi alın.
          </p>
          <m.a
            href={whatsappHref}
            target="_blank"
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Masa Sandalye Tamiri Hakkında Merak Edilenler"
          description="Mersin'de yerinde masa sandalye tamiri hizmetiyle ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Masa sandalye tamiri iletişim">
  ...
  const icons: Record<ServiceWorkStageIcon, ReactNode> = {
    screw: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M10 13h4v2l-2 6-2-6v-2z" strokeLinejoin="round" />
      </svg>
    ),
    leg: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M6 4h12v4H6z" strokeLinejoin="round" />
        <path d="M8 8v12M16 8v12" strokeLinecap="round" />
        <path d="M7 20h2M15 20h2" strokeLinecap="round" />
      </svg>
    ),
    joint: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M12 4v5M12 15v5" strokeLinecap="round" />
      </svg>
    ),
    backrest: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M6 20V10c0-3 2.5-5 6-5s6 2 6 5v10" strokeLinecap="round" />
...
function ProblemIcon({
  ...
  const icons: Record<ServiceProblemIcon, ReactNode> = {
    wobble: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M8 5c2-2 6-2 8 0" strokeLinecap="round" />
        <path d="M7 10h10M8 10v8M16 10v8M7 18h10" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M5 21h14" strokeLinecap="round" />
      </svg>
    ),
    broken: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M7 4h10v5l-3 3 3 3v5H7v-5l3-3-3-3V4z" strokeLinejoin="round" />
      </svg>
    ),
    loose: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
    ...
    table: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M4 9h16v3H4z" strokeLinejoin="round" />
        <path d="M7 12v8M17 12v8M5 20h4M15 20h4" strokeLinecap="round" />
      </svg>
    ),
    chair: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M7 4v8h10V4" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M5 12h14v2H5z" strokeLinejoin="round" />
        <path d="M7 14v6M17 14v6M6 20h2M16 20h2" strokeLinecap="round" />
      </svg>
    ),
    onsite: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
