...
export function KapiOnarimPageContent() {
  return (
    <>
      <ServiceHeroSection />
...
function HeroShowcase({
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[10px] font-bold text-cream-50 sm:text-xs">Kapı Onarım</p>
      </m.div>
    </m.div>
  );
}
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="max-w-xl text-sm leading-relaxed text-wood-700 sm:text-base">
            Siz de kapınızın fotoğrafını gönderin, yapılabilecek onarım işlemleri hakkında ön bilgi alın.
          </p>
          <m.a
            href={whatsappHref}
            target="_blank"
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Kapı Onarım Hakkında Merak Edilenler"
          description="Mersin'de yerinde kapı onarım hizmetiyle ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Kapı onarım iletişim">
...
function WorkStageIcon({
  ...
  const icons: Record<ServiceWorkStageIcon, ReactNode> = {
    ...
    fill: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M12 3l7 4v5c0 4.5-3 7.5-7 8.5-4-1-7-4-7-8.5V7l7-4z" strokeLinejoin="round" />
  ...
  const icons: Record<ServiceProblemIcon, ReactNode> = {
    crack: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M10 7l2 4-2 3 3 4" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    paint: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
