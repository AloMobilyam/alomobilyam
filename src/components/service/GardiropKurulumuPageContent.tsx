...
} from "@/lib/services/gardirop-kurulumu";
...
type ServiceIconName = ServiceWorkStageIcon | ServiceProblemIcon;

export function GardiropKurulumuPageContent() {
  return (
    <>
      <ServiceHeroSection />
      <WorkStagesSection />
...
function HeroShowcase({
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[10px] font-bold text-cream-50 sm:text-xs">Güvenli Montaj</p>
      </m.div>
    </m.div>
  );
}
    ...
    >
      ...
      <span
        className={`absolute left-1.5 top-1.5 z-10 rounded-full px-1.5 py-0.5 text-[8px] font-bold tracking-wider sm:left-2 sm:top-2 sm:px-2 sm:text-[9px] ${
          highlight ? "bg-emerald-700/90 text-white" : "bg-wood-900/85 text-cream-50"
        }`}
      >
        {label}
      </span>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <m.div
          className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4 lg:gap-6"
          initial="hidden"
          whileInView="visible"
          viewport={viewportOnce}
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="max-w-xl text-sm leading-relaxed text-wood-700 sm:text-base">
            Siz de gardırop fotoğraflarınızı gönderin, kurulum hakkında ön bilgi alın.
          </p>
          <m.a
            href={whatsappHref}
            target="_blank"
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Gardırop Kurulumu Hakkında Merak Edilenler"
          description="Mersin'de yerinde gardırop kurulumu hizmetiyle ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Gardırop kurulumu iletişim">
  ...
  const icons: Record<ServiceIconName, ReactNode> = {
    ...
    drawer: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M4 11h16M10 15h4" strokeLinecap="round" />
      </svg>
    ),
    onsite: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
