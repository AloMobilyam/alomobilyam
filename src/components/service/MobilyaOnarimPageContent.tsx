...
} from "@/lib/services/mobilya-onarim";
...
export function MobilyaOnarimPageContent() {
  return (
    <>
      <ServiceHeroSection />
...
function HeroShowcase({
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[10px] font-bold text-cream-50 sm:text-xs">Ekonomik Onarım</p>
      </m.div>
    </m.div>
  );
}
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <m.div
          ...
          variants={fadeInUp}
          role="region"
          aria-label="Mobilya onarım ile yeni mobilya karşılaştırması"
        >
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="max-w-xl text-sm leading-relaxed text-wood-700 sm:text-base">
            Siz de mobilyanızın fotoğrafını gönderin, yapılabilecek onarım işlemleri hakkında ön bilgi alın.
          </p>
          <m.a
            href={whatsappHref}
            target="_blank"
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Mobilya Onarım Hakkında Merak Edilenler"
          description="Mersin'de yerinde mobilya onarım hizmetiyle ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Mobilya onarım iletişim">
...
function OperationIcon({
  ...
  const icons: Record<ServiceOperationIcon, ReactNode> = {
    ...
    strengthen: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M12 3l7 4v5c0 5-3.5 8.5-7 9-3.5-.5-7-4-7-9V7l7-4z" strokeLinejoin="round" />
