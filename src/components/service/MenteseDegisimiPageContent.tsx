...
} from "@/lib/services/mentese-degisimi";
...
export function MenteseDegisimiPageContent() {
  return (
    <>
      <ServiceHeroSection />
      <WorkStagesSection />
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="max-w-xl text-sm leading-relaxed text-wood-700 sm:text-base">
            Siz de kapak ve menteşe fotoğrafınızı gönderin, yapılabilecek işlemler hakkında ön bilgi alın.
          </p>
          <m.a
            href={whatsappHref}
            target="_blank"
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Menteşe Değişimi Hakkında Merak Edilenler"
          description="Mersin'de yerinde menteşe değişimi hizmetiyle ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Menteşe değişimi iletişim">
...
function ProblemIcon({
  ...
  const icons: Record<ServiceProblemIcon, ReactNode> = {
    ...
    broken: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M12 2l2.5 5.5L20 9l-4.5 3.5L17 19l-5-3-5 3 1.5-6.5L4 9l5.5-1.5L12 2z" strokeLinejoin="round" />
        <path d="M9 12l6-2" strokeLinecap="round" />
      </svg>
    ),
    kitchen: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
