...
} from "@/lib/services/mobilya-yenileme";
...
export function MobilyaYenilemePageContent() {
  return (
    <>
      <ServiceHeroSection />
...
function HeroShowcase({
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[10px] font-bold text-cream-50 sm:text-xs">Kapak Değişimi</p>
      </m.div>
    </m.div>
  );
}
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <m.div
          ...
          variants={fadeInUp}
          role="region"
          aria-label="Mobilya yenileme ile sıfırdan değiştirme karşılaştırması"
        >
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="max-w-xl text-sm leading-relaxed text-wood-700 sm:text-base">
            Siz de mobilyanızın fotoğrafını gönderin, kapak değişimi ve yenileme seçenekleri hakkında ön bilgi alın.
          </p>
          <m.a
            href={whatsappHref}
            target="_blank"
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Mobilya Yenileme Hakkında Merak Edilenler"
          description="Mersin'de yerinde mobilya yenileme hizmetiyle ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Mobilya yenileme iletişim">
