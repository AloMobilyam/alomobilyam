...
export function DolapKapakAyariPageContent() {
  return (
    <>
      <ServiceHeroSection />
      <WorkStagesSection />
...
function ProceduresSection() {
  return (
    <section
      id="uygulanan-islemler"
      className="section-padding scroll-mt-14 bg-white sm:scroll-mt-20"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow={SERVICE_PROCEDURES_SECTION.eyebrow}
          title={SERVICE_PROCEDURES_SECTION.title}
          description={SERVICE_PROCEDURES_SECTION.description}
        />
        ...
        <m.div
          ...
          variants={staggerContainer}
        >
          {SERVICE_PROCEDURES.map((procedure) => (
            <m.article
              key={procedure.id}
              variants={fadeInUp}
            ...
            >
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-wood-100 to-wood-200 text-wood-700 transition-colors duration-300 group-hover:from-wood-800 group-hover:to-wood-900 group-hover:text-cream-50 sm:h-11 sm:w-11 sm:rounded-2xl">
                <ProcedureIcon name={procedure.icon} className="h-5 w-5" />
              </div>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="max-w-xl text-sm leading-relaxed text-wood-700 sm:text-base">
            Siz de kapak fotoğrafınızı gönderin, yapılabilecek işlemler hakkında ön bilgi alın.
          </p>
          <m.a
            href={whatsappHref}
            target="_blank"
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Dolap Kapak Ayarı Hakkında Merak Edilenler"
          description="Mersin'de yerinde dolap kapak ayarı hizmetiyle ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Dolap kapak ayarı iletişim">
...
function WorkStageIcon({
  ...
  const icons: Record<ServiceWorkStageIcon, ReactNode> = {
    ...
    bath: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M4 12h16v5a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3v-5z" strokeLinejoin="round" />
        <path d="M6 12V7a2 2 0 0 1 2-2h1" strokeLinecap="round" />
      </svg>
    ),
    wardrobe: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
  ...
  const icons: Record<ServiceProblemIcon, ReactNode> = {
    ...
    sag: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M15 8l3 4-3 4" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    gap: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
...
function ProcedureIcon({
  ...
  name: ServiceProcedureIcon;
  className?: string;
}) {
  const icons: Record<ServiceProcedureIcon, ReactNode> = {
    tighten: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <circle cx="12" cy="12" r="3" />
        <path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41" strokeLinecap="round" />
    ...
    screw: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M12 8v8M9 10l3-2 3 2M9 14l3 2 3-2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    replace: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M4 12a8 8 0 0 1 13.66-5.66M20 12a8 8 0 0 1-13.66 5.66" strokeLinecap="round" />
        <path d="M17 4v4h4M7 20v-4H3" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    check: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
