...
} from "@/lib/services/tekne-tik-ahsap-bakimi";
import { fadeInUp, scaleIn, staggerContainer, viewportOnce } from "@/lib/motion";
import { ServiceBeforeAfterGallery } from "./ServiceBeforeAfterGallery";
...
export function TekneTikAhsapBakimiPageContent() {
  return (
    <>
      <ServiceHeroSection />
...
function HeroShowcase({
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[10px] font-bold text-cream-50 sm:text-xs">Tik Bakım</p>
      </m.div>
    </m.div>
  );
}
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="max-w-xl text-sm leading-relaxed text-wood-700 sm:text-base">
            Siz de tekne ahşaplarınızın fotoğrafını gönderin; tik bakım ve vernik seçenekleri hakkında ön bilgi alın.
          </p>
          <m.a
            href={whatsappHref}
            target="_blank"
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Tekne Tik ve Ahşap Bakımı Hakkında Merak Edilenler"
          description="Mersin'de tekne tik bakımı, ahşap küpeşte vernik ve kamara yenileme ile ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Tekne tik ve ahşap bakımı iletişim">
...
function CleanIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
      ...
      <path d="M7 20V10l5-6 5 6v10" strokeLinejoin="round" />
...
function SandIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
      ...
      <path d="M7 12h10M8 10h8M8 14h8" strokeLinecap="round" />
    </svg>
  );
}
...
function OilIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
      <path d="M12 3c-3 4-5 6.5-5 9.5a5 5 0 0 0 10 0C17 9.5 15 7 12 3z" strokeLinejoin="round" />
      <path d="M10 15h4" strokeLinecap="round" />
    </svg>
  );
}

function VarnishIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
      <path d="M8 3h8l1 5H7l1-5z" strokeLinejoin="round" />
      <path d="M9 8v10a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2V8" />
...
function CabinIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
      ...
      <path d="M4 11h16M9 11v9M15 11v9" />
      <path d="M8 6V4h8v2" />
    </svg>
  );
}
...
function MarineIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
      <path d="M3 17c2 1 4 1 6 0s4-1 6 0 4 1 6 0" strokeLinecap="round" />
      <path d="M12 4v10" strokeLinecap="round" />
      <path d="M12 7l7 3H5l7-3z" strokeLinejoin="round" />
    </svg>
  );
}
...
function RailIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
      ...
      <path d="M6 8v8M12 8v8M18 8v8" strokeLinecap="round" />
    </svg>
  );
}
...
function WorkStageIcon({
  ...
  const icons: Record<ServiceWorkStageIcon, ReactNode> = {
    clean: <CleanIcon className={className} />,
    sand: <SandIcon className={className} />,
    joint: <JointIcon className={className} />,
    oil: <OilIcon className={className} />,
    varnish: <VarnishIcon className={className} />,
    cabin: <CabinIcon className={className} />,
    carpentry: <CarpentryIcon className={className} />,
    marine: <MarineIcon className={className} />,
  };
...
function OperationIcon({
  ...
  const icons: Record<ServiceOperationIcon, ReactNode> = {
    ...
    oil: <OilIcon className={className} />,
    joint: <JointIcon className={className} />,
    rail: <RailIcon className={className} />,
    cabin: <CabinIcon className={className} />,
    carpentry: <CarpentryIcon className={className} />,
    refresh: <RefreshIcon className={className} />,
    varnish: <VarnishIcon className={className} />,
    restore: <RestoreIcon className={className} />,
  };
