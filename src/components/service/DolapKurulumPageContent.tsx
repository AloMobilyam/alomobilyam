...
import {
  SERVICE_CABINET_TYPES,
  SERVICE_CABINET_TYPES_SECTION,
  SERVICE_DESCRIPTION,
  SERVICE_FAQS,
  SERVICE_HERO,
  ...
  type ServiceCabinetTypeIcon,
  type ServiceWorkStageIcon,
} from "@/lib/services/dolap-kurulum";
...
export function DolapKurulumPageContent() {
  return (
    <>
      <ServiceHeroSection />
      <WorkStagesSection />
...
function HeroShowcase({
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[10px] font-bold text-cream-50 sm:text-xs">Profesyonel Kurulum</p>
      </m.div>
    </m.div>
  );
}
...
function CabinetTypesSection() {
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow={SERVICE_CABINET_TYPES_SECTION.eyebrow}
          title={SERVICE_CABINET_TYPES_SECTION.title}
          description={SERVICE_CABINET_TYPES_SECTION.description}
        />
        ...
        <m.div
          ...
          variants={staggerContainer}
        >
          {SERVICE_CABINET_TYPES.map((item) => (
            <m.article
              key={item.id}
              variants={fadeInUp}
            ...
            >
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-wood-100 to-wood-200 text-wood-700 transition-colors duration-300 group-hover:from-wood-800 group-hover:to-wood-900 group-hover:text-cream-50 sm:h-11 sm:w-11 sm:rounded-2xl">
                <CabinetTypeIcon name={item.icon} className="h-5 w-5" />
              </div>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="max-w-xl text-sm leading-relaxed text-wood-700 sm:text-base">
            Siz de dolap fotoğrafınızı gönderin, kurulum hakkında ön bilgi alın.
          </p>
          <m.a
            href={whatsappHref}
            target="_blank"
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Dolap Kurulum Hakkında Merak Edilenler"
          description="Mersin'de yerinde dolap kurulum hizmetiyle ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Dolap kurulum iletişim">
...
function CabinetTypeIcon({
  name,
  className = "h-5 w-5",
}: {
  name: ServiceCabinetTypeIcon;
  className?: string;
}) {
  const icons: Record<ServiceCabinetTypeIcon, ReactNode> = {
    cabinet: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
