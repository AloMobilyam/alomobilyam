...
} from "@/lib/services/mobilya-montaj-demontaj";
...
export function MobilyaMontajDemontajPageContent() {
  return (
    <>
      <ServiceHeroSection />
      <WorkStagesSection />
...
function HeroShowcase({
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[10px] font-bold text-cream-50 sm:text-xs">Profesyonel Montaj</p>
      </m.div>
    </m.div>
  );
}
...
function ProcessSection() {
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow={SERVICE_PROCESS_SECTION.eyebrow}
          title={SERVICE_PROCESS_SECTION.title}
          description={SERVICE_PROCESS_SECTION.description}
        />
        ...
        >
          {SERVICE_PROCESS_STEPS.map((step) => (
            <m.article
              key={step.id}
              variants={fadeInUp}
              className="rounded-2xl border border-wood-100 bg-cream-50 p-4 shadow-sm ring-1 ring-wood-100/80 sm:p-5"
            >
              <span className="mb-3 inline-flex h-8 w-8 items-center justify-center rounded-full bg-wood-800 text-sm font-bold text-cream-50">
                {step.id}
              </span>
              <h3 className="font-serif text-base font-bold text-wood-900 sm:text-lg">
                {step.title}
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="max-w-xl text-sm leading-relaxed text-wood-700 sm:text-base">
            Siz de mobilya fotoğrafınızı gönderin, montaj veya demontaj hakkında ön bilgi alın.
          </p>
          <m.a
            href={whatsappHref}
            target="_blank"
    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Montaj ve Demontaj Hakkında Merak Edilenler"
          description="Mersin'de yerinde mobilya montaj ve demontaj hizmetiyle ilgili en çok sorulan soruların kısa yanıtları."
        />
...
function WhatsAppCtaSection() {
  return (
    <section className="bg-wood-900 py-10 sm:py-14" aria-label="Mobilya montaj demontaj iletişim">
  ...
  const icons: Record<ServiceWorkStageIcon, ReactNode> = {
    frame: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M4 8h16M8 3v18M16 3v18" strokeLinecap="round" />
      </svg>
    ),
    panel: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
...
function ProblemIcon({
  ...
  const icons: Record<ServiceProblemIcon, ReactNode> = {
    move: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M3 17h13v-6H3zM16 14h3l2 3v3h-5z" strokeLinejoin="round" />
    ...
    cabinet: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M4 10h16M12 10v10" strokeLinecap="round" />
      </svg>
    ),
    wardrobe: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
    ...
    vestiyer: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        ...
        <path d="M5 10h14M9 14h6" strokeLinecap="round" />
      </svg>
    ),
    align: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
